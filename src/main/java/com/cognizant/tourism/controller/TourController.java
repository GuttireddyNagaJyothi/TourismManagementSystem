...
public class TourController 
{
	...
	public String tourDetails(@ModelAttribute("tour") Tourism tour,Model model)
	{
		boolean b=tourismService.checkTour(tour.getId());
		if(!b)
		{
			return "redirect:/tour/searchTour";
		}
		else
		{
			Tourism tourDetails=tourismService.searchTour(tour.getId());
